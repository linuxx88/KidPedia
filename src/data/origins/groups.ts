...
export const villageSubNodes: HistoryNode[] = [
  { 
    id: 'gv1', 
    page: 1, 
    color: '#92400e', 
  ...
  { 
    ...
    color: '#10b981', 
    icon: '🏙️', 
    title: { fr: 'La Première Ville', en: 'The First City' }, 
    description: { fr: 'Bienvenue à Jéricho, le plus vieux village du monde ! C\'est l\'heure du quiz !', en: 'Welcome to Jericho, the oldest village in the world! It\'s quiz time!' },
    topicId: 'histoire' 
  },
];
