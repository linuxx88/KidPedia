...
export const bigBangSubNodes: HistoryNode[] = [
  { 
    id: 'bb1', 
    page: 1, 
    color: '#ef4444', 
  ...
  { 
    ...
    description: { fr: "Notre maison est prête pour la vie ! C'est l'heure du quiz !", en: "Our home is ready for life! It's quiz time!" },
    topicId: 'terre' 
  },
];
