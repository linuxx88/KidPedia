...
export const middleAgesSubNodes: HistoryNode[] = [
  { 
    id: 'ma1', 
    page: 1, 
    color: '#475569', 
  ...
  { 
    ...
    color: '#0f172a', 
    icon: '🚀', 
    title: { fr: 'L\'Aube des Temps Modernes', en: 'Dawn of Modern Times' }, 
    description: { fr: 'L\'imprimerie arrive ! C\'est la fin du Moyen-Âge et le début d\'une nouvelle ère. C\'est l\'heure du quiz !', en: 'Printing arrives! It is the end of the Middle Ages and the beginning of a new era. It\'s quiz time!' },
    topicId: 'histoire' 
  },
];
