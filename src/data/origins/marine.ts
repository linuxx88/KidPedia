...
export const marineSpeciesSubNodes: HistoryNode[] = [
  { 
    id: 'ms1', 
    page: 1, 
    color: '#0ea5e9', 
  ...
  { 
    ...
    color: '#059669', 
    icon: '🐸', 
    title: { fr: 'Le grand saut !', en: 'The big jump!' }, 
    description: { fr: 'Prêt à découvrir ce qu\'il y a sur la terre ferme ? C\'est l\'heure du quiz !', en: 'Ready to discover what\'s on dry land? It\'s quiz time!' },
    topicId: 'animaux' 
  },
];
